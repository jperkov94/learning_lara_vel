                                ...
                                <li class="product-item">
                                    <div class="product product-widget-style">
                                        <div class="thumbnnail">
                                            <a href="{{ route('details.controller', ['slug' => $popular->slug]) }}"
                            ...
                            @foreach ($related_products as $related)
                                <div class="product product-style-2 equal-elem ">
                                    <div class="product-thumnail">
                                        <a href="{{ route('details.controller', ['slug' => $related->slug]) }}"
                                            title="{{ $related->name }}">
                                            <figure><img
                                                    src="{{ asset('assets/images/products') }}/{{ $related->image }}"
                                                    width="214" height="214" alt="{{ $related->name }}">
                                            </figure>
                                        </a>
