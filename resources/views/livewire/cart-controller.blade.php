                        ...
                        @foreach (Cart::content() as $cart)
                            <li class="pr-cart-item">
                                <div class="product-image">
                                    <figure><img src="{{ asset('assets/images/products') }}/{{ $cart->model->image }}"
                                            alt=""></figure>
                                </div>
                                <div class="product-name">
                                    <a class="link-to-product"
                                        href="{{ route('details.controller', ['slug' => $cart->model->slug]) }}">{{ $cart->model->name }}</a>
                                </div>
                                ...
                                <div class="quantity">
                                    <div class="quantity-input">
                                        <input type="text" name="product-quatity" value="{{ $cart->qty }}"
                                            data-max="120" pattern="[0-9]*">
                                        <a class="btn btn-increase" href="#"
                                            wire:click.prevent="increaseQuantity('{{ $cart->rowId }}')"></a>
                                        <a class="btn btn-reduce" href="#"
                                            wire:click.prevent="decreaseQuantity('{{ $cart->rowId }}')"></a>
                                    </div>
                                </div>
                                ...
                                <div class="delete">
                                    <a href="#" class="btn btn-delete" title=""
                                        wire:click.prevent="destroyProduct('{{ $cart->rowId }}')">
