                                ...
                                @auth
                                    @if (Auth::user()->utype === 'ADM')
                                        <li class="menu-item"><a title="Register or Login"
                                                href="{{ route('admin.dashboard') }}">Hello
                                                Admin {{ Auth::user()->name }}</a></li>
                                    @else
                                        <li class="menu-item"><a title="Register or Login"
                                                href="{{ route('user.dashboard') }}">Hello
                                                user {{ Auth::user()->name }}</a></li>
                                    @endif

                                    <li class="menu-item"><a href="{{ route('logout') }}" onclick="event.preventDefault();document.getElementById('logout-form').submit();">Exit</a></li>
                    ...
                    <div class="primary-nav-section">
                        <div class="container">
                            <ul class="nav primary clone-main-menu" id="mercado_main" data-menuname="Main menu">
                                ...
                                <li class="menu-item">
                                    <a href="{{ route('shop.controller') }}"
                                        class="link-term mercado-item-title">Shop</a>
                                </li>
                                <li class="menu-item">
                                    <a href="{{ route('cart.controller') }}"
                                        class="link-term mercado-item-title">Cart</a>
                                </li>
                                <li class="menu-item">
                                    <a href="{{ route('checkout.controller') }}"
